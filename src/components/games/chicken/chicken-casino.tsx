...
export function ChickenCasino({ game }: { game: Game }) {
        ...
        {showRules && (
          <section className={styles.rules} aria-label="Règles de Chicken">
            ...
            <p>
              ...
              déterminé par le jeu. Les autres poulets jouent en direct chacun à
              son rythme.
            </p>
          </section>
        )}
        ...
        <section className={styles.stage} aria-label="Route de Chicken">
          ...
          <div className={styles.stageFooter}>
            <strong className={styles.runInfo}>
              ...
              <span>
                {visualStep
                  ? multiplier(chickenMultiplier(currentDifficulty, visualStep))
                  : "Départ"}
              </span>
            </strong>
            <span>
            ...
            >
              {CHICKEN_DIFFICULTY_ORDER.map((item) => (
                <GameOption
                  ...
                  onClick={() => {
                    setDifficulty(item);
                    setSteps(Math.min(steps, CHICKEN_MULTIPLIERS[item].length));
                  }}
                >
