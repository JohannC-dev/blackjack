...
CREATE TABLE "wallet_account" (
	...
	"balance_minor" bigint DEFAULT 200000 NOT NULL,
	"version" bigint DEFAULT 0 NOT NULL,
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	"updated_at" timestamp with time zone DEFAULT now() NOT NULL,
	CONSTRAINT "wallet_balance_non_negative" CHECK ("wallet_account"."balance_minor" >= 0)
);
--> statement-breakpoint
...
CREATE INDEX "wallet_entry_user_created_idx" ON "wallet_entry" USING btree ("user_id","created_at");--> statement-breakpoint
CREATE INDEX "wallet_entry_reference_idx" ON "wallet_entry" USING btree ("reference_id");