...
- Choisir un jeton puis cliquer sur le tapis. Viser le **bord** d’un numéro joue le cheval avec son voisin (y compris 0/1, 0/2 et 0/3 sur la ligne du zéro), un **coin** joue le carré ; les numéros couverts s’allument avant le clic. Clic droit pour retirer une mise. Mises par pas de 5, 500 crédits maximum par tour.
