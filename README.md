...
- Après chaque étage réussi, encaisser `mise × multiplicateur` ou continuer. Le 10ᵉ étage est encaissé automatiquement. Multiplicateur = `(n / (n − 1))^étage × 0,93`, soit ×8,66 (Facile), ×16,51 (Normal), ×53,63 (Difficile) et ×952,32 (Impossible) au sommet. Avec la cagnotte Lucky, la Tower rend 96 % des mises.
